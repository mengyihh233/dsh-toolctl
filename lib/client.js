...
function ToolCtlPanel() {
  ...
  const btn = import_react.default.createElement("button", {
    onClick: () => setOpen(!open),
    title: "\u5DE5\u5177\u63A7\u5236\uFF1A\u9690\u85CF\u4E0D\u7528\u7684\u5DE5\u5177\uFF0C\u7701 token",
    style: { background: "transparent", border: "none", cursor: "pointer", fontSize: 16, padding: "4px 6px" }
  }, "\u{1F6E0}\uFE0F");
  if (!open) return btn;
  const rows = data === null ? import_react.default.createElement("div", { className: "toolctl-meta" }, "\u52A0\u8F7D\u4E2D\u2026") : data.tools.map(
    (t) => import_react.default.createElement(
      "label",
      { key: t.name, className: "toolctl-row" },
      import_react.default.createElement("input", { type: "checkbox", checked: !data.deny.includes(t.name), onChange: () => toggle(t.name) }),
      import_react.default.createElement("span", { className: "toolctl-name" }, t.name),
      t.description ? import_react.default.createElement("span", { className: "toolctl-desc" }, t.description) : null
    )
  );
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("div", { style: { fontWeight: 700, marginBottom: 8 } }, "\u5DE5\u5177\u63A7\u5236"),
      import_react.default.createElement(
        "div",
...
function apply(ctx) {
  ...
  slots.inject(
    ...
    () => slots.register(
      ...
      () => import_react.default.createElement(ToolCtlPanel, null)
    )
  );
}
